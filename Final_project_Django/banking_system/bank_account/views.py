...
def register_view(request):
    if request.method == 'POST':
        ...
        form = RegisterForm()
    return render(request, 'bank_account/register.html', {'form': form})
...
def login_view(request):
    ...
    return render(request, 'bank_account/login.html', {'form': form})
...
def dashboard_view(request):
    ...
    return render(request, 'bank_account/dashboard.html', {'account': account, 'transactions': transactions})
...
def deposit_view(request):
    ...
    if request.method == 'POST':
        ...
        form = DepositForm()
    return render(request, 'bank_account/deposit.html', {'form': form})
...
def withdraw_view(request):
    ...
    if request.method == 'POST':
        ...
        form = WithdrawForm()
    return render(request, 'bank_account/withdraw.html', {'form': form})
...
def emi(request):
    ...
    return render(request, 'bank_account/finance.html', {
        'emi': emi_result,
        'error': error
    })
@login_required
def sip(request):
    ...
    return render(request, 'bank_account/sip.html', {
...
def fd(request):
    ...
    return render(request, 'bank_account/FD.html', {
...
def rd(request):
    ...
    return render(request, 'bank_account/RD.html', {
...
def estimate(request):
    ...
    return render(request, 'bank_account/retirement.html', {
...
def home_loan_estimator_view(request):
    ...
    return render(request, 'bank_account/home_loan.html', {
...
def credit_card_interest_view(request):
    ...
    return render(request, 'bank_account/credit_card.html', {
        'balance': balance,
...
def taxable(request):
    ...
    return render(request, 'bank_account/taxable.html', {
...
def simple_budget_planner_view(request):
    ...
    return render(request, 'bank_account/simple_budget.html', {'result': result, 'error_message': error_message})
...
def net_worth_view(request):
    ...
    return render(request, 'bank_account/net_worth.html', {
        'net_worth': result,
        'error_message': error_message  # Ensure this is passed to template
    })
@login_required
def loan_form_page(request):
    return render(request, 'bank_account/predictor_form.html')

# # # Result page
# # def predict_loan_amount_get(request):
# #     try:
# #         # Get inputs from form (GET parameters)
# #         age = float(request.GET['Age'])
# #         income = float(request.GET['Monthly_Income'])
# #         score = float(request.GET['Credit_Score'])
# #         tenure = float(request.GET['Loan_Tenure_Years'])
# #         existing = float(request.GET['Existing_Loan_Amount'])
# #         dependents = float(request.GET['Num_of_Dependents'])

# #         features = [[age, income, score, tenure, existing, dependents]]
...
def predict_loan_amount_get(request):
    try:
        ...
        return render(request, 'bank_account/prediction_result.html', {
